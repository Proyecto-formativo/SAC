<div class="container">
  ...
  <a href="<?= base_url('Administrador/FrmAgregarCoordinador'); ?>" class="btn bg-sena mb-3">Agregar</a>
  <div class="table-responsive">
    <table id="coordinadores" class="table table-striped table-bordered" style="width: 100%;">
      <thead>
        <tr>
          <th>Documento</th>
      ...
      <tbody>
        <?php foreach ($coordinadores->result() as $coordinador) : ?>
          <tr>
            ...
            <?php if ($coordinador->docidusuario == null) : ?>
