<div class="container">
  <a href="<?= base_url('Administrador/FrmAgregarBienestar'); ?>" class="btn bg-sena">Agregar</a>
  <div class="table-responsive">
    <table id="bienestar" class="table table-striped table-bordered mt-3" style="width: 100%;">
      <thead>
        <tr>
          <th>Documento</th>
