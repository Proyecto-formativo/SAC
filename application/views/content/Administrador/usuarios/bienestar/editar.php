<div class="container">
    ...
    <div class="row">
      <div class="col-6">
        <div class="form-group">
          ...
          <input type="text" name="docid" class="form-control" placeholder="Documento Identidad" value="<?= $bien->documento; ?>" id="docid" readonly>
  ...
  <?php else : ?>
    <div class="mt-3">
      ...
      <form action="<?= base_url('Administrador/darAccesoBienestar'); ?>" method="POST">
        <input type="hidden" name="documento" value="<?= $bien->documento; ?>">
        <div class="row">
          <div class="col-6">
            <div class="form-group">
  ...
  <a href="<?= base_url('Administrador/bienestar'); ?>" class="btn bg-sena mt-3">Regresar Al Modulo Bienestar</a>
</div>
...
<div class="modal fade" id="denegarAccesoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('Administrador/denegarAccesoBienestar'); ?>" method="POST">
