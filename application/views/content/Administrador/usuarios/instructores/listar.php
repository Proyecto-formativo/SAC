<div class="container">
  ...
  <a href="<?= base_url('Administrador/FrmAgregarInstructor'); ?>" class="btn bg-sena mb-3">Agregar</a>
  <div class="table-responsive">
    <table id="instructores" class="table table-striped table-bordered" style="width: 100%;">
      <thead>
        <tr>
          <th>Documento</th>
