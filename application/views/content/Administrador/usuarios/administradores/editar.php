<div class="container">
    ...
    <div class="row">
      <div class="col-6">
        <div class="form-group">
          ...
          <input type="text" name="docid" class="form-control" placeholder="Documento Identidad" value="<?= $administrador->documento; ?>" id="docid" readonly>
  ...
  <?php else : ?>
    <div class="mt-3">
      ...
      <form action="<?= base_url('Administrador/darAccesoAdministrador'); ?>" method="POST">
        <input type="hidden" name="documento" value="<?= $administrador->documento; ?>">
        <div class="row">
          <div class="col-6">
            <div class="form-group">
...
<div class="modal fade" id="denegarAccesoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('Administrador/denegarAccesoAdministrador'); ?>" method="POST">
