...
<div class="row">
	<div class="col-4" style="padding:0;">
		<input type="text" name="tarea" value="AREA"  class="areal" style="  margin-left:10%; width:90%; text-align:center;"  readonly="readonly">
	</div>
	<div class="col-4"style="padding:0;" >
...
<div class="row">
	<div class="col-4" style="padding:0;">
		<input type="text" name="consecut" value="PROGRAMA"  class="areal"  style="margin-left:10%; width:90%; text-align:center;"   readonly="readonly">
	</div>
	<div class="col-8"style="padding:0;" >
		<input type="text" name="programa" value=<?=$reporte[0]->programa;?>""  id="programa" style="width:97.5%;"  readonly="readonly">
	</div>
	<div class="col-2" style="padding:0;">
		<input type="text" name="consecut" value="NIVEL"  class="areal"  style="margin-left:20%; width:80%;text-align:center;"   readonly="readonly">
	</div>
	<div class="col-2" style="padding:0;">
	...
	<div class="col-4" style="padding:0;">
		<input type="text" name="consecut" value="CENTRO"  class="areal"  style="margin-left:10%; width:90%;text-align:center;" >
	</div>
	<div class="col-8"style="padding:0;" >
...
<div class="row">
	<div class="col-4" style="padding:0;">
		<input type="text" name="consecut" value="SEDE" class="areal"  style="margin-left:10%; width:90%; text-align:center;"   readonly="readonly">
	</div>
	<div class="col-8"style="padding:0;" >
		<input type="text" name="sede" value="<?=$reporte[0]->sede;?>"  id="sede" style="width:97.5%;" >
	</div>
	<div class="col-4" style="padding:0;">
		<input type="text" name="consecut" value="ETAPA FORMACION" class="areal"  style="margin-left:10%; width:90%; text-align:center;"   readonly="readonly">
	</div>
	<div class="col-8" style="padding:0;">
...
<div class="row">
	<div class="col-3" style="padding:0;">
		<input type="text" name="consecut" value="ETAPA PROYECTO"  class="areal"  style="margin-left:13.5%; width:86.5%; text-align:center;"   readonly="readonly">
	</div>
	<div class="col-3"style="padding:0;" >
	...
	<!----------instructor reporte-->
	<div class="col-4" style="padding:0;">
		<input type="text" name="consecut" value="INSTRUCTOR REPORTE "  class="areal" style="margin-left:10%;   width:90%; text-align:center;"   readonly="readonly">
	</div>
	<div class="col-8" style="padding:0;">
...
<div class="row">
	<div class="col-12" style="padding:0;">
		<input type="text" name="consecut" value="NORMAS REGLAMENTO"  class="areal" style="width:100%; text-align:center;"  readonly="readonly" >
	</div>
	<div class="col-12" style="padding:0;">
	...
	<div class="row">
		<div class="col-6" style="padding:0;">
			<input type="text" name="consecut" value="SUGERENCIA"  class="areal" style="width:100%; text-align:center;"  readonly="readonly" >
		</div>
		<div class="col-6" style="padding:0;">
...
<div class="row">
	<div class="col-3" style="padding:0;">
		<input type="text" name="consecut" value="TIPO FALTA" style="width:100%; text-align:center;"  class="areal" readonly="readonly">
	</div>
	<div class="col-3" style="padding:0;">
	...
	<div class="col-3" style="padding:0;">
		<input type="text" name="consecut" value="CALIF. FALTA" style="width:100%; text-align:center;" class="areal"  readonly="readonly">
	</div>
	<div class="col-3" style="padding:0;">
